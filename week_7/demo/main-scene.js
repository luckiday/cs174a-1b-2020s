window.Assignment_Four_Scene = window.classes.Assignment_Four_Scene =
    class Assignment_Four_Scene extends Scene_Component {
        constructor(context, control_box)     // The scene begins by requesting the camera, shapes, and materials it will need.
        {
            ...
            // shapes.box_1.texture_coords = shapes.box_1.texture_coords.map(v => Vec.of(v[1] * 3 - 0.5, v[0] * 2));
            ...
            this.materials =
                {
                    ...
                    box_1: context.get_instance(Texture_Rotate).material(
                        ...
                        {
                            ambient: 1,
                            texture: context.get_instance("./assets/demo.png")
                        }
                    ),
                };
...
class Texture_Rotate extends Phong_Shader {
    fragment_glsl_code() {
        ...
        { 
          ...
          vec4 tex_color = texture2D( texture, r * (f_tex_coord.xy - 1.) + 1. );    
